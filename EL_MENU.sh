...
if [ "$response" = "y" ]; then
	...
	printf "\n"
	sleep 3
	echo "We are currently hosting the Kaloud Krysalis Monarch Collection..."
	printf "\n"
    ...
    cat<<EOF
==========================================
Please select your Kaloud Krysalis hookah:
------------------------------------------
...
EOF
    read -n1 -s
    case "$REPLY" in
    "1") echo "You chose Anahata Edition from the Kaloud Krysalis Monarch Collection.";;
    "2") echo "You chose Illuminate Edition from the Kaloud Krysalis Monarch Collection.";;
    "3") echo "You chose Hayat Edition from the Kaloud Krysalis Monarch Collection.";;
    "4") echo "You chose Shakti Edition from the Kaloud Krysalis Monarch Collection.";;
    "5") echo "You chose Astral Edition from the Kaloud Krysalis Monarch Collection.";;
    "6") echo "QUITER!"
         printf "\n"
           sleep 1
...
# Flavors Menu
        ...
        cat<<EOF
=====================================
Pick a flava - 1000g of fresh shisha:
-------------------------------------
...
EOF
    read -n1 -s
    case "$REPLY" in
    "1") echo "You chose 1K g of Cherry Vanilla shisha.";;
    "2") echo "You chose 1K of Lemon Mint shisha.";;
    "3") echo "You chose 1K of Mocha shisha.";;
    "4") echo "You chose 1K of Orange Soda shisha.";;
    "5") echo "You chose 1K of Strawberry Mojito.";;
...
printf "\n"
printf "\n"
echo "REMEMBER YOUR CHOICES(S)!!!"
sleep 3
# Total Payment
clear
         cat<<EOF
===========================================
What was your choice: (Security Purposes)
-------------------------------------------
